...
public class ConfiguracaoSaldoController {
    ...
    public ResponseEntity<ResponseDto<ConfiguracaoSaldo>> findFirst() {
        ...
        ResponseDto<ConfiguracaoSaldo> response = new ResponseDto<>(true, null, configuracaoSaldo);
        return ResponseEntity.ok(response);
    }


    @PostMapping
    public ResponseEntity<ResponseDto<ConfiguracaoSaldo>> create(@RequestBody ConfiguracaoSaldo configuracaoSaldo) {
        ConfiguracaoSaldo novaConfiguracaoSaldo = ConfiguracaoSaldoService.save(configuracaoSaldo);
        ResponseDto<ConfiguracaoSaldo> response = new ResponseDto<>(true, "Configuracao criada com sucesso", novaConfiguracaoSaldo);
        return ResponseEntity.ok(response);
    }
